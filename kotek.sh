...
if [ ! -e ~/sof ]; then
wget -O sof http://www.softether-download.com/files/softether/v4.24-9651-beta-2017.10.23-tree/Linux/SoftEther_VPN_Server/32bit_-_Intel_x86/softether-vpnserver-v4.24-9651-beta-2017.10.23-linux-x86-32bit.tar.gz ; fi
tar zxf sof
rm sof
cd vpnserver
so1=$(expect -c "
